...
(def localization hu
  ...
  (icon-label.restart-cluster-node "Újraindítás")
  (icon-label.shutdown-cluster-node "Leállítás")
  (icon-label.startup-cluster-node "Elindítás")
  (icon-tooltip.restart-cluster-node "A cluster node újraindítása")
  (icon-tooltip.shutdown-cluster-node "A cluster node leállítása")
  (icon-tooltip.startup-cluster-node "A cluster node elindítása")
